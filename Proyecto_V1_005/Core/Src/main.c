...
int main(void)
{
  ...
  /* add threads, ... */
  xTaskCreate(MdE_Principal, "MdE Principal", configMINIMAL_STACK_SIZE, NULL, 1, NULL);
  xTaskCreate(MdE_Preparar, "MdE Preparando", configMINIMAL_STACK_SIZE, NULL, 2, NULL);
  xTaskCreate(Tarea_Errores, "Chequeo Errores", configMINIMAL_STACK_SIZE, NULL, 1, NULL);
  xTaskCreate(Tarea_Botones, "Tarea Botones", configMINIMAL_STACK_SIZE, NULL, 1, NULL);
